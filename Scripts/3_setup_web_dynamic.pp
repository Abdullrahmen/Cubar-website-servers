...
exec {'Sets up the web servers for the deployment of web_dynamic_nodejs':
  provider => shell,
  command  => 'sudo mkdir -p /data/web_dynamic_nodejs/releases/test /data/web_dynamic_nodejs/shared; 
			   sudo chown -hR ubuntu:ubuntu /data/;
			   cp /home/ubuntu/Scripts/initial_nodejs.js /data/web_dynamic_nodejs/releases/test/main.js; 
